...
function westprocter_init() {
    ...
    textbar.innerHTML = "Welcome to WestProctor!";
    ...
    //logo.innerHTML = "<img src='https://dl.dropboxusercontent.com/u/14050575/projects/westproctor_aux/westprocter_intellect.png'>";
    logo.style.top = window.height-window.height + 'px';
    logo.style.top = 10 + 'px';
    //logo.style.left = window.width-460 + 'px';
    logo.style.left = 10 + 'px';
    document.body.appendChild(logo);

} 

function westprocter_update() {
...
function say(message) {
    textbar.innerHTML = message;
}

function sphere(radius, red, green, blue) {
    temp_geom = new THREE.SphereGeometry(radius);
    temp_material = new THREE.MeshLambertMaterial( {color: red*255*256*256+green*255*256+blue*255} );
    mesh = new THREE.Mesh(temp_geom, temp_material);
    scene.add(mesh); 
    return mesh;
}


function rectangle(length, width, height, red, green, blue) {
    temp_geom = new THREE.CubeGeometry(length, width, height);
    temp_material = new THREE.MeshLambertMaterial( {color: red*255*256*256+green*255*256+blue*255} );
    mesh = new THREE.Mesh(temp_geom, temp_material);
    scene.add(mesh); 
    return mesh;
...
function cylinder(radius, height, red, green, blue) {
    temp_geom = new THREE.CylinderGeometry(radius, radius, height, 20);
    temp_material = new THREE.MeshLambertMaterial( {color: red*255*256*256+green*255*256+blue*255} );
    mesh = new THREE.Mesh(temp_geom, temp_material);
    scene.add(mesh); 
    return mesh;
...
function color(object, red, green, blue) {
    object.material.color.r = red; 
    object.material.color.g = green; 
    object.material.color.b = blue; 
}

function connect(object_parent, object_child) {
    object_parent.add(object_child);
}

function motor(object, angle) {
